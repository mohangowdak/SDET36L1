...
public class CreateProductsTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String expectedProductName = sheet.getRow(2).getCell(1).getStringCellValue()+randomNumber;
		...
		String actualLastName = driver.findElement(By.xpath("//span[@id='dtlview_Product Name']")).getText();

		//validating contact last name
		if(actualLastName.equals(expectedProductName))
		{
			System.out.println("Product created successfully---> TC is Pass");
		}
		else {
			System.out.println("Product is not created---> TC is Fail");
		}
