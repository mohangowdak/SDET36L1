...
public class CreateOrganizationWithIndustryAndTypeTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String expectedOrganizionName = sheet.getRow(4).getCell(1).getStringCellValue().trim()+randomNumber;
		String expectedIndustry = sheet.getRow(4).getCell(2).getStringCellValue().trim();
		String expectedType = sheet.getRow(4).getCell(3).getStringCellValue().trim();
		String expectedAssignedTo = sheet.getRow(4).getCell(4).getStringCellValue().trim();
